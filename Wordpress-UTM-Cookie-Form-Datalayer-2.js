window.addEventListener("load", (event) => {
    ...
    function setUTMformValues(doc) {
        ...
        function set_utm_field(utm_type) {
            ...
            let queryStringOne = 'input[name=\'form_fields[' + utm_type + ']\']';
            let queryStringTwo = 'input[name*=\'' + utm_type + '\']';
            
            // Combine both query strings in one using a comma-separated selector
            let combinedQuery = `${queryStringOne}, ${queryStringTwo}`;
            
            let utm_nodes = document.querySelectorAll(combinedQuery);
